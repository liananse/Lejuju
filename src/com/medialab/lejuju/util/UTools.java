...
public class UTools {
	...
	public static final class Storage
	{
		 ...
		 * 2013-7-22
		 */
		public static String getEventBgImagePath()
		{
			String path = null;
			
			String dir = UDataStorage.getExternalStoragePublicDirectory(UDataStorage.Dir_Pictures) + "/pyj/temp/";
			path = dir + "event_bg_image.jpg";
		 ...
		 * 2013-7-22
		 */
		public static String getEventSmallBgImagePath()
		{
			String path = null;
			
			String dir = UDataStorage.getExternalStoragePublicDirectory(UDataStorage.Dir_Pictures) + "/pyj/temp/";
			path = dir + "event_bg_image_1080.jpg";
			UDataStorage.ensureDir(dir);
		...
		public static String getEventDetailImagePath()
		{
			String path = null;
			
			String dir = UDataStorage.getExternalStoragePublicDirectory(UDataStorage.Dir_Pictures) + "/pyj/temp/pics/";
		...
		public static String getEventDetailSmallImagePath()
		{
			...
			String dir = UDataStorage.getExternalStoragePublicDirectory(UDataStorage.Dir_Pictures) + "/pyj/temp/smallpics/";
			path = dir + System.currentTimeMillis() + ".jpg";
		...
		public static String getEventPicSaveImagePath()
		{
			String path = null;
			
			String dir = UDataStorage.getExternalStoragePublicDirectory(UDataStorage.Dir_Pictures) + "/pyj/save/";
			path = dir + System.currentTimeMillis() + ".jpg";
